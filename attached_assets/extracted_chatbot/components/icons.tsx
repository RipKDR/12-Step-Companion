...
export const SparklesIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
        <path d="m12 3-1.9 1.9-1.1-3-1.1 3-1.9-1.9L3 6l1.9 1.9-3 1.1 3 1.1-1.9 1.9L6 15l1.9-1.9 1.1 3 1.1-3 1.9 1.9L15 12l-1.9-1.9 3-1.1-3-1.1 1.9-1.9Z"/>
    </svg>
);
...
export const BrainCircuitIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
        ...
        <path d="M19 12a3 3 0 1 0-5.993.134"/>
        <path d="M5 12a3 3 0 1 1 5.993.134"/>
        <path d="m14.6 8.9-.01.01"/>
        <path d="m9.4 8.9-.01.01"/>
        <path d="m14.6 15.1-.01.01"/>
        <path d="m9.4 15.1-.01.01"/>
    </svg>
);
